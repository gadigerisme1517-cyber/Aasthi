...
const SECTIONS = [
  ...
  { h: "How it's used", p: "We never sell your data. When you send an inquiry, request a number or schedule a visit on a listing, two things happen: your name and your message are sent to that seller, and that seller's phone number is shown to you on the listing. Nothing is exchanged before you contact someone. Your phone number is shown to buyers only on properties you publish yourself, because a listing has to be reachable." },
